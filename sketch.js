...
var bg, l_wall1, cave_img, score, bg_bl,bg_br,bg_tr,bg_tl, gamestatex,gamestatey,cwolf,Xwall, Ywall
...
/*if (gamestatex === "r" && gamestatey === "b") { 
  ...
  cwolf = loadImage("images/c-wolf.png");
